...
import medidas_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class medidas(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "medidas")
        ...
        self.qtgui_number_sink_0_3.set_title("Desviaciòn estàndar")
        ...
        self.qtgui_number_sink_0_2.set_title("Potencia promedio señal")
        ...
        self.qtgui_number_sink_0.set_title("RMS señal")
        ...
        self.connect((self.epy_block_0, 2), (self.qtgui_number_sink_0, 0))
...
def main(top_block_cls=medidas, options=None):
