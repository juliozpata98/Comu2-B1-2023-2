...
class punto_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.rational_resampler_xxx_2, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.rational_resampler_xxx_1, 0))
